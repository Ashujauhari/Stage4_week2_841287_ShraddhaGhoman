...
public class EmployeeController {
	...
	public Employee getEmployeeById(@PathVariable @Valid int emp_id) throws EmployeeNotFoundException{
		// TODO Auto-generated method stub
		return employeeServiceImpl.getEmployeeById(emp_id);
	}

	@PutMapping(value ="/{emp_id}")
	public Employee updateEmployeeDetails(@PathVariable @Valid int emp_id,@RequestBody Employee employee) throws EmployeeNotFoundException{
		// TODO Auto-generated method stub
	...
	public String deleteEmployee(@PathVariable @Valid int emp_id) throws EmployeeNotFoundException{
		// TODO Auto-generated method stub
